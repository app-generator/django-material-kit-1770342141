...
class UserProfile(models.Model):
    ...
    #__PROFILE_FIELDS__
    token_balance = models.IntegerField(null=True, blank=True)
    tokens_sent = models.IntegerField(null=True, blank=True)
    tokens_received = models.IntegerField(null=True, blank=True)
